...
import { WMO } from "@/constants/weathercodes";
...
export default function Index() {
  ...
  const codeData = data.current;
  const code = codeData.weathercode ?? 0;
  const meta = WMO[code] || { label: "-", icon: "weather-cloudy" };
  ...
  return (
    ...
    >
      ...
      <CurrentWeatherCard current={codeData} meta={meta} />
